...
urlpatterns = [
    ...
    re_path(r'^aac/dp/create/$',views.CreateDegreeProgram.as_view(), name='add-dp'),
    re_path(r'^aac/dp/update/(?P<pk>\d+)/$',views.UpdateDegreeProgram.as_view(), name='update-dp'),
    re_path(r'^aac/report/create/$',views.CreateReport.as_view(),name='add-rpt'),
