...
urlpatterns = [
    ...
    re_path(r'^report/(?P<report>\d+)/assessment/supplements/upload/(?P<assessIR>\d+)/$', views.SupplementUpload.as_view(), name='assessment-supplement'),
    ...
    re_path(r'^report/(?P<report>\d+)/assessment/supplements/delete/(?P<sup>\d+)/$', views.DeleteSupplement.as_view(), name='delete-supplement'),
